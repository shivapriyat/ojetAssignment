  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'incidents', detail: { label: 'Setting up a Python development environment', iconClass: 'oj-ux-ico-fire' } },
        { path: 'customers', detail: { label: 'Getting started with Python', iconClass: 'oj-ux-ico-contact-group' } },
        { path: 'about', detail: { label: 'Python 2 support on Google Cloud', iconClass: 'oj-ux-ico-information-s' } }
      ];
